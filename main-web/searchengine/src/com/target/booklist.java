...
public class booklist {
	...
	private ArrayList<hword> wordlist=new ArrayList<>();
	private ArrayList<banurl> bhlist=new ArrayList<>();
	private ArrayList<sugmess> smlist=new ArrayList<>();
	Booksql sql;
	...
	public void input(String name,String author,String origin,String sketch,String type,String url) {
		...
		book b=new book(name, author, origin, sketch, type,url,0);
		blist.add(b);
		b.save(sql);
	}
	}
