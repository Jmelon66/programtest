...
//	    }
	...
	public void run(int SleepTime, int RetryTimes, int CycleRetryTimes, int pag, int type, int maxcount) {
		if(SleepTime>0){
		...
		System.out.println("开始爬取..."+r.getUrl()
				+ this.pag + ".html");
		startTime = System.currentTimeMillis();
		Spider.create(this)
				.addUrl(r.getUrl()
						+ this.pag + ".html").thread(5).run();
